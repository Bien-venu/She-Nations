  ...
  posts: [
    {
      ...
      content:
        "I'm preparing for salary negotiations and would love to hear your experiences and tips.",
      author: "Jessica Wong",
    ...
    },
    {
      ...
      content:
        "Looking for recommendations on courses, books, and practical projects to get started with ML.",
      author: "Priya Sharma",
      authorAvatar: "/placeholder.svg?height=40&width=40",
      category: "Learning",
      likes: 18,
    ...
    },
    {
      ...
      content:
        "Sharing my journey and sessions learned from founding my first startup.",
      ...
      tags: ["startup", "entrepreneurship", "sessions"],
    },
  ],
  replies: [
    {
  ...
  reducers: {
    addPost: (
      ...
      action: PayloadAction<
        Omit<Post, "id" | "likes" | "replies" | "createdAt">
      >
    ) => {
      const newPost: Post = {
        ...action.payload,
